            ...
            <div id="vitalSigns" className="w-full pt-0 bg-gray-100 rounded text-black shadow-xl font-bold">
              ...
              <div className="p-2">
                <div className="bg-gray-200 p-5 m-2 rounded text-black">
                  <ChartBar title="News Scores" data={data.newsScores} minTimestamp={minTimestamp} maxTimestamp={maxTimestamp} height="100">
                ...
                <div className="bg-gray-200 p-5 m-2 rounded text-black">
                  <ChartBar title="Respiration rate" data={data.observations['Respiration rate']} minTimestamp={minTimestamp} maxTimestamp={maxTimestamp} height="50"/></div>
                
                <div className="bg-gray-200 p-5 m-2 rounded text-black">
                  <ChartBar title="Systolic blood pressure" data={data.observations['Systolic blood pressure']} minTimestamp={minTimestamp} maxTimestamp={maxTimestamp} height="50"/></div>
                
                <div className="bg-gray-200 p-5 m-2 rounded text-black">
                  <ChartBar title="Pulse rate" data={data.observations['Pulse rate']} minTimestamp={minTimestamp} maxTimestamp={maxTimestamp} height="50"/></div>
                
                <div className="bg-gray-200 p-5 m-2 rounded text-black">
                  <ChartBar title="Oxygen saturation" data={data.observations['Oxygen saturation']} minTimestamp={minTimestamp} maxTimestamp={maxTimestamp} height="50"/></div>
                
                <div className="bg-gray-200 p-5 m-2 rounded text-black">
                  <ChartBar title="Temperature" data={data.observations['Temperature']} minTimestamp={minTimestamp} maxTimestamp={maxTimestamp} height="50"/></div>
              </div>
