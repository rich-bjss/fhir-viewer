...
function Header(props: any) {
    ...
    return (
        <header className="bg-blue-600 w-full fixed">
            <nav className="mx-auto flex max-w-7xl items-center justify-between py-3 px-4 lg:px-8 border-b-2" aria-label="Global">
                {/* LOGO */}
                <div className="flex lg:flex-1">
                <a href="#" className="-m-1.5 p-1.5">
                    {/* <span className="sr-only">Hack Day</span> */}
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <form className={props.loggedIn ? "flex items-center gap-x-1 text-sm font-semibold leading-6 text-white" : "hidden"}>
                        {/* <label> NHS Number: </label> */}
                        <input placeholder="NHS Number" className="px-2 rounded italic font-normal text-black" type="text"></input>
                        <button type="button" className="px-2 border border-white hover:bg-white hover:text-blue-600 text-white rounded">Search </button>
                    </form>
                    <a href="#" className={props.loggedIn ? "hidden" : "text-sm font-semibold leading-6 text-white"}>Log in <span aria-hidden="true">&rarr;</span></a>
                </div>
            </nav>
